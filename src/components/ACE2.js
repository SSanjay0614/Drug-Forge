  ...
  return (
    <div style={containerStyle}>
      <div style={cardStyle}>
        ...
        <h2 style={subTitleStyle}>Angiotensin-Converting Enzyme 2 (ACE2)</h2>
        <p style={infoStyle}>
        ...
        <p style={infoStyle}>
          The BBBP (Blood-Brain Barrier Penetration) prediction model uses machine learning algorithms to predict the likelihood of a compound penetrating the blood-brain barrier, which is essential for the development of drugs that target the central nervous system.
        </p>
